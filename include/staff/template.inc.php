<?php
if(!defined('KTKADMININC') || !$thisuser->isadmin() || !is_object($template)) die(_('Access Denied'));
...
<form action="admin.php?t=templates" method="post">
  ...
  <table width="100%" border="0" cellspacing=0 cellpadding=0>
        ...
        <table width="100%" border="0" cellspacing=0 cellpadding=2 class="tform tpl">
            ...
            <tr>
                ...
                <td><i><?= _('Administrative notes') ?></i> &nbsp; <font class="error">&nbsp;<?=$errors['notes']?></font>
                    <br /><textarea rows="5" cols="75" name="notes"><?=$tpl['notes']?></textarea></td>
            </tr>
        </table>
    ...
    <tr><td style="padding-left:175px">
        ...
        <input class="button" type="button" name="cancel" value="<?= _('Cancel') ?>" onClick='window.location.href="admin.php?t=templates"'></td>
    </tr>
